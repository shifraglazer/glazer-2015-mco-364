...
public class SnakeCell {
	...
	public void drawHeadUpDown(Graphics g) throws IOException {
		...
		g.fillOval(((int) (width / 3) + x), ((int) (height / 4) + y),
				(int) (width / 5), (int) (height / 5));
		g.fillOval(((int) (width / 3) + x), ((int) (height / 4 * 2) + y),
				(int) (width / 5), (int) (height / 5));
		g.setColor(Color.RED);
		if (!eating) {
			g.drawArc(((int) (width / 3 * 2) + x), ((int) (height / 4) + y),
					(int) (width / 3), (int) (height / 2), 90, -180);
		} else {
			g.drawOval((int) (width / 3 * 2) + x, ((int) (height / 4) + y),
	...
	public void drawHeadSide(Graphics g) throws IOException {
		...
		g.fillOval(((int) (width / 3) + x), ((int) (height / 4) + y),
				(int) (width / 5), (int) (height / 5));
		g.fillOval(((int) (width / 3 * 2) + x), ((int) (height / 4) + y),
				(int) (width / 5), (int) (height / 5));
		g.setColor(Color.RED);
		if (!eating) {
			g.drawArc(((int) (height / 3) + x), ((int) (width / 4 * 2) + y),
					(int) (width / 2), (int) (height / 3), 0, -180);
		} else {
			g.drawOval(((int) (height / 3) + x), ((int) (width / 4 * 2) + y),
